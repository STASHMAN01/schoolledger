...
export const metadata: Metadata = {
  ...
  description:
    "Set up your preschool or crèche on Crechely in a few minutes — no card required, 14 days free.",
  alternates: { canonical: "/register" },
  openGraph: {
    title: "Start your free trial | Crechely",
    description: "Set up your preschool on Crechely — no card required, 14 days free.",
  },
};
