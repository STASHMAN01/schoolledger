...
export async function POST(req: NextRequest) {
  try {
    ...
    await sendMail({
      to: user.email,
      subject: "Reset your SchoolLedger password",
      text: `We got a request to reset your SchoolLedger password. This link works once and expires in ${RESET_EXPIRY_MINUTES} minutes:\n\n${resetUrl}\n\nIf you didn't ask for this, you can ignore this email — your password hasn't been changed.`,
      html: `
        <p>We got a request to reset your SchoolLedger password.</p>
